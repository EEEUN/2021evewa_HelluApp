...
import com.example.HelluApp.DailyStamp.CustomAdapter;
...
public class feed_recent extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_feed_recent, container, false);
        ...
        databaseReference = database.getReference("All_Write"); // DB 테이블 연결
